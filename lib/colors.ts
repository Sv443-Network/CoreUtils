/**
 * @module colors
 * This module contains various functions for working with colors - [see the documentation for more info](https://github.com/Sv443-Network/DJSUtils/blob/main/docs.md#colors)
 */
